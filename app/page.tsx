  ...
  return (
    ...
    >
      ...
      <section className="flex flex-col lg:flex-row w-full h-[100vh] pt-24 md:pt-32 lg:pt-40">
        ...
        <div className="relative flex items-center w-full lg:w-1/2 px-6 lg:px-0 order-1 lg:order-2 mb-10 pb-[100px] lg:mb-0">
          ...
          <div className="w-full lg:w-[90%] xl:w-[80%] 2xl:w-[70%] flex flex-col gap-4 md:gap-5">
            <div
              className={`inline-flex items-center w-fit rounded-full border px-2 py-1.5 sm:px-2 sm:py-2 text-xs sm:text-sm ${
                isDarkMode ? "border-gray-700" : "border-gray-300"
              }`}
            >
              <span
                className={`mr-2 rounded-full px-2 py-[5px] text-xs font-medium ${
            ...
            <p
              className={`text-sm sm:text-base md:text-lg lg:text-xl font-light ${
                isDarkMode ? "text-[#2A7523]" : "text-green-700"
              }`}
            >
              Escape the clutter and chaos—Whether you're tackling work,
              studying, or managing tasks, PomoSync helps you stay on track with
              focused work sessions and strategic breaks.
            </p>
            <div className="buttons flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 mt-2">
              <Button
                className={`font-bold text-base sm:text-lg md:text-xl py-4 px-5 md:p-6 rounded-2xl md:rounded-3xl border-[0.1em] border-[#84CC16] w-full sm:w-auto ${
                  isDarkMode ? "bg-[#3D4142] text-white" : "bg-white text-black"
                }`}
              >
                Explore Features
              </Button>
      ...
      <section className="relative w-full overflow-hidden">
        <div
          className={`absolute inset-0 rounded-tl-[6vw] rounded-tr-[6vw] ${
            isDarkMode
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 md:py-24 flex flex-col items-center text-center">
          <h2
            className={`text-xl md:text-2xl font-light tracking-widest mb-2 md:mb-4 ${
              isDarkMode ? "text-black opacity-50" : "text-gray-700 opacity-70"
            }`}
          >
            INTRODUCING
          </h2>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="top flex flex-col md:flex-row pt-5">
            <div className="flex flex-col">
              <div
                className={`inline-flex items-center w-fit rounded-full border px- py-1.5 sm:px-2 sm:py-2 text-xs sm:text-sm ${
                  isDarkMode ? "border-gray-700" : "border-gray-300"
                }`}
              >
                <span
                  className={`mr-2 rounded-full bg-white px-1.5 py-0.5 text-xs font-bold ${
            ...
            <div className="flex items-center">
              <p
                className={`${
                  isDarkMode ? "text-[#37A52D]" : "text-green-700"
                }`}
              >
                Stay in control of your productivity with powerful tools
                designed for deep focus, seamless workflow, and smarter time
                management.
              </p>
            </div>
          </div>
            ...
            <div className="content flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
              <ul className="flex flex-wrap gap-8 lg:w-1/2">
                <li className="transition-transform hover:-translate-y-1 duration-300 w-full sm:w-[calc(50%-1rem)]">
                  <div
                    className={`p-4 rounded-lg w-14 h-14 flex items-center justify-center mb-4 shadow-lg ${
                  ...
                  >
                    Customize your work and break intervals to match your
                    productivity rhythm.
                  </p>
                </li>
      ...
      <section className={`${isDarkMode ? "bg-black" : "bg-white"} py-10 px-4`}>
        <div
          className={`max-w-[82em] mx-auto flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-8 rounded-2xl ${
            isDarkMode
              ? "bg-gradient-to-r from-[#00BEC5] to-[#7FFF00]"
              : "bg-gradient-to-r from-[#00BEC5] to-[#7FFF00]"
          }`}
        >
          ...
          <div className="flex flex-col mt-auto sm:flex-row gap-4">
            <button
              className={`px-5 py-3 flex items-center gap-2 rounded-lg ${
                isDarkMode
