...
function CardTop() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div
        id="cycles-container"
        className="long-break-button flex flex-col space-y-[24px]"
      >
        <ModesIndicator
          title="Current Mode"
          subText="Current timer cycle"
          modeBadge={<ModeBadge mode={mode} />}
        />
        <ModesIndicator
          title="Next Mode"
          subText="Which cycle will be activated"
          modeBadge={<ModeBadge mode={Modes.LONG_BREAK} />}
        />
      </div>
      ...
      <div
        id="clock-container"
        className="flex w-full justify-center items-center p-[24px] mt-[64px]"
      >
        <CircularTimer />
      </div>
    </div>
