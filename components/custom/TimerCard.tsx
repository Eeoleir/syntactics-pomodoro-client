        ...
        {showTooltip && (
          ...
          >
            <div className="w-full flex lg:justify-start justify-end">
              <div
                style={{ backgroundColor: colors(mode) }}
                className="w-5 h-5 rotate-45 absolute ml-5 mr-5 -mt-1 col-span-0"
              ></div>
            </div>
            <div className="grid grid-cols-10 py-6 px-6 space-x-2">
              ...
              <div className="flex flex-col col-span-8 justify-center space-y-1">
                ...
                <p className="text-sm">
                  {badgeTranslations(`${mode}.description`)}
                </p>
              </div>
              <div className="col-span-1 flex justify-center -mt-[7.5px]">
                ...
                >
                  ...
                  >
                    <path
                      d="M1.227 9.83653L0.163574 8.7731L3.93667 5L0.163574 1.2519L1.227 0.188477L5.0001 3.96158L8.7482 0.188477L9.81162 1.2519L6.03852 5L9.81162 8.7731L8.7482 9.83653L5.0001 6.06343L1.227 9.83653Z"
                      fill="white"
                    />
                  </svg>
                </Button>
